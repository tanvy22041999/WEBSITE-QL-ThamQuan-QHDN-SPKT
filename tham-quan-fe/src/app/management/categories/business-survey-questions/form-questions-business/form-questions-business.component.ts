...
@Component({
  selector: 'app-form-questions-business',
  templateUrl: './form-questions-business.component.html',
  styleUrls: ['./form-questions-business.component.scss']
})
export class FormQuestionsBusinessComponent implements OnInit {

  @Input() modalData: ModalData<CauHoiKhaoSatDoanhNghiep>;
  @Input() thuTu: number;
