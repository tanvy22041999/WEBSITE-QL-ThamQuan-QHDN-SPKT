...
@Component({
  selector: 'app-form-question-guide',
  templateUrl: './form-question-guide.component.html',
  styleUrls: ['./form-question-guide.component.scss']
})
export class FormQuestionGuideComponent implements OnInit {

  @Input() modalData: ModalData<CauHoiKhaoSatCTV>;
